...
namespace Toggl.Foundation.Tests.Sync.States.Push
{
    public sealed class DeleteEntityStateTests : BasePushEntityStateTests
    {
        ...
        public void TracksEntitySyncErrorInCaseOfFailure(Type entityType)
        {
            ...
            var state = new DeleteEntityState<ITestModel, IDatabaseTestModel, IThreadSafeTestModel, IDatabaseTestModel>(api, dataSource, analyticsService);
        ...
        protected override BasePushEntityState<IThreadSafeTestModel, IDatabaseTestModel> CreateState()
            => new DeleteEntityState<ITestModel, IDatabaseTestModel, IThreadSafeTestModel, IDatabaseTestModel>(api, dataSource, analyticsService);
